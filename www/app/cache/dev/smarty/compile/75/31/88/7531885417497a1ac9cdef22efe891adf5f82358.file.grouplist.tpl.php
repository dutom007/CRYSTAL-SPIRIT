<?php /* Smarty version Smarty-3.1.19, created on 2017-05-17 23:44:37
         compiled from "/home/crystalsdx/www/modules/pssliderlayer/views/templates/hook/grouplist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2051622721591d18a54fe469-82964651%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7531885417497a1ac9cdef22efe891adf5f82358' => 
    array (
      0 => '/home/crystalsdx/www/modules/pssliderlayer/views/templates/hook/grouplist.tpl',
      1 => 1491211281,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2051622721591d18a54fe469-82964651',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_591d18a559cfb3_25468041',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_591d18a559cfb3_25468041')) {function content_591d18a559cfb3_25468041($_smarty_tpl) {?>
<fieldset>
...
?>
                        <tr class=" odd">
                            <td class="text-center"><strong>#<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['group']->value['id_pssliderlayer_groups'],'htmlall','UTF-8');?>
</strong></td>
                            <td <?php if ($_smarty_tpl->tpl_vars['group']->value['id_pssliderlayer_groups']!=$_smarty_tpl->tpl_vars['curentGroup']->value) {?>onclick="document.location = '<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminModules'),'htmlall','UTF-8');?>
&configure=pssliderlayer&editgroup=1&id_group=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['group']->value['id_pssliderlayer_groups'],'htmlall','UTF-8');?>
'"<?php }?> class="pointer">
                                <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['group']->value['title'],'htmlall','UTF-8');?>
...
" class="btn " style="color:#BBBBBB">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminModules'),'htmlall','UTF-8');?>
&configure=pssliderlayer&deletegroup=1&id_group=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['group']->value['id_pssliderlayer_groups'],'htmlall','UTF-8');?>
...
" class="group-preview">
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['language']->value['name'],'htmlall','UTF-8');?>
                                                    ...
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <a class="group-preview" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['previewLink']->value,'htmlall','UTF-8');?>
&id_group=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['group']->value['id_pssliderlayer_groups'],'htmlall','UTF-8');?>
">
                                                        <i class="icon-eye-open"></i> <?php echo smartyTranslate(array('s'=>'Preview Group','mod'=>'pssliderlayer'),$_smarty_tpl);?>

                                                    </a>
                                                <?php }?>
                                                <a class="" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['exportLink']->value,'htmlall','UTF-8');?>
&id_group=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['group']->value['id_pssliderlayer_groups'],'htmlall','UTF-8');?>
">
...
&configure=pssliderlayer&editgroup=1&copylang=1&id_group=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['group']->value['id_pssliderlayer_groups'],'htmlall','UTF-8');?>
">
...
&configure=pssliderlayer&showsliders=1&id_group=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['group']->value['id_pssliderlayer_groups'],'htmlall','UTF-8');?>
                ...
                <tbody>
                    <tr class=" odd">
                        <td colspan="2" style="margin-top:10px;padding:10px">
                            <form method="post" enctype="multipart/form-data" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminModules'),'htmlall','UTF-8');?>
