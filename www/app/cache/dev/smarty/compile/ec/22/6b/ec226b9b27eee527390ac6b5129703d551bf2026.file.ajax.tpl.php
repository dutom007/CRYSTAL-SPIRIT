<?php /* Smarty version Smarty-3.1.19, created on 2017-05-15 06:09:12
         compiled from "/home/crystalsdx/www/modules/pspagebuilder/views/templates/admin/helpers/uploader/ajax.tpl" */ ?>
<?php /*%%SmartyHeaderCode:200417504659197e4878e631-02383784%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec226b9b27eee527390ac6b5129703d551bf2026' => 
    array (
      0 => '/home/crystalsdx/www/modules/pspagebuilder/views/templates/admin/helpers/uploader/ajax.tpl',
      1 => 1491211280,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '200417504659197e4878e631-02383784',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59197e48815581_24370152',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59197e48815581_24370152')) {function content_59197e48815581_24370152($_smarty_tpl) {?>
...
?>
		...
		<div class="img-thumbnail text-center">
			<p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['file']->value['image'],'html','UTF-8');?>
</p>
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['file']->value['size'],'html','UTF-8');?>
kb</p><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['file']->value['delete_url'])) {?>
			<p>
				<a class="btn btn-default" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['file']->value['delete_url'],'html','UTF-8');?>
">
...
<?php }?>
		...
		<button class="ladda-button btn btn-default" data-style="expand-right" type="button" id="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['id']->value,'html','UTF-8');?>
...
<div class="row" style="display:none">
	<div class="alert alert-info" id="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['id']->value,'html','UTF-8');?>
-files-list"></div>
</div>
<div class="row" style="display:none">
...
').fileupload({
			...
			<?php if (isset($_smarty_tpl->tpl_vars['post_max_size']->value)) {?>maxFileSize: <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['post_max_size']->value,'html','UTF-8');?>
,<?php }?>
...
');
			...
			data.context = $('<div/>').addClass('row').appendTo($('#<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['id']->value,'html','UTF-8');?>
-files-list'));
