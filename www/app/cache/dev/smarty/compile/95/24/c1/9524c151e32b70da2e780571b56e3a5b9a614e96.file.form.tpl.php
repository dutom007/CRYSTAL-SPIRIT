<?php /* Smarty version Smarty-3.1.19, created on 2017-05-15 06:05:49
         compiled from "/home/crystalsdx/www/modules/pspagebuilder/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:154139346459197d7deb4e36-39149152%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9524c151e32b70da2e780571b56e3a5b9a614e96' => 
    array (
      0 => '/home/crystalsdx/www/modules/pspagebuilder/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1491211280,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '154139346459197d7deb4e36-39149152',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59197d7e357749_94095639',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59197d7e357749_94095639')) {function content_59197d7e357749_94095639($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/crystalsdx/www/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
?>
                            <div id="categorytab_<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
">
                                <label>Set icon for: <strong><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
</strong></label>
                                <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                    <label>Icon Class</label>
                                    <input type="text" name="categorytab[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][icon_class]" class="icon_class_category" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['icon_class'],'html','UTF-8');?>
">

                                    <label>Icon</label>
                                    <input type="text" name="categorytab[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][icon]" class="icon_category" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['icon'],'html','UTF-8');?>
">
                                </div>
                                <br><br>
                            </div>
                            ...
                            <script type="text/javascript">
                                $('#categorytab_<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
...
$_smarty_tpl->tpl_vars['val']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['val']->key;
?>
                            <div id="promotions_<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
" class="promotion_item">
                                <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                    <label>Title</label>
                                    <input type="text" name="promotions[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][title]" class="title_promotion" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['title'],'html','UTF-8');?>
">

                                    <label>Description</label>
                                    <textarea class="rte_promotion rte_promotion_<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
" name="promotions[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][description]">
                                    ...
                                    <label>Url</label>
                                    <input type="text" name="promotions[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][url]" class="url_promotion" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['url'],'html','UTF-8');?>
">

                                    <label>Image</label>
                                    <input type="text" name="promotions[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][image]" class="image_promotion" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['image'],'html','UTF-8');?>
">
                    ...
                    <?php } else { ?>
                        <div id="promotions_0" class="promotion_item">
                            <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                ...
                                <label>Image</label>
                                <input type="text" name="promotions[0][image]" class="image_promotion" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['image'],'html','UTF-8');?>
">
                            </div>
                            <br><br>
                        </div>
...
$_smarty_tpl->tpl_vars['val']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['val']->key;
?>
                            <div id="pro_slide_<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
" class="pro_slide_item">
                                <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                <div>
                                    <label>Background</label>
                                    <input type="text" name="products_slideshow[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][background]" class="background_pro_slide" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['background'],'html','UTF-8');?>
">
                                </div>
                                <div>
                                    <label>Image</label>
                                    <input type="text" name="products_slideshow[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][image]" class="image_pro_slide" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['image'],'html','UTF-8');?>
">
                                    </div>
                                    <label>Product Id</label>
                                    <input type="text" name="products_slideshow[<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['key']->value,'html','UTF-8');?>
][id_product]" class="product_pro_slide" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['id_product'],'html','UTF-8');?>
">
                    ...
                    <?php } else { ?>
                        <div id="pro_slide_0" class="promotion_item">
                            <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                <div>
                                <label>Background</label>
                                <input type="text" name="products_slideshow[0][background]" class="background_pro_slide" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['background'],'html','UTF-8');?>
">
                                </div>
                                <div>
                                <label>Image</label>
                                <input type="text" name="products_slideshow[0][image]" class="image_pro_slide" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['image'],'html','UTF-8');?>
">
                                </div>
                                <label>Product Id</label>
                                <input type="text" name="products_slideshow[0][id_product]" class="product_pro_slide" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['val']->value['id_product'],'html','UTF-8');?>
">
                            </div>
                            <br><br>
                        </div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '154139346459197d7deb4e36-39149152');
content_59197d7e253520_92264156($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-05-15 06:05:50
         compiled from "/home/crystalsdx/www/admin13497682/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_59197d7e253520_92264156')) {function content_59197d7e253520_92264156($_smarty_tpl) {?>
