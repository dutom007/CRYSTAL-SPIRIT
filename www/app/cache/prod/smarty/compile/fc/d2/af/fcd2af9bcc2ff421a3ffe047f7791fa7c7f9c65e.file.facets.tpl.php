<?php /* Smarty version Smarty-3.1.19, created on 2017-07-05 10:54:47
         compiled from "/home/crystalsdx/www/themes/foliage/templates/catalog/_partials/facets.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1710081151595cfdb75bebe2-12183870%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fcd2af9bcc2ff421a3ffe047f7791fa7c7f9c65e' => 
    array (
      0 => '/home/crystalsdx/www/themes/foliage/templates/catalog/_partials/facets.tpl',
      1 => 1495630991,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1710081151595cfdb75bebe2-12183870',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_595cfdb763f270_60161226',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_595cfdb763f270_60161226')) {function content_595cfdb763f270_60161226($_smarty_tpl) {?>
  <div id="search_filters" class="block">
    <h4 class="title-sidebar hidden-sm-down"><?php echo smartyTranslate(array('s'=>'Filter By','d'=>'Shop.Theme.Actions'),$_smarty_tpl);?>
</h4>
...
?>
        <?php if ($_smarty_tpl->tpl_vars['facet']->value['displayed']) {?>
          <section class="facet">
            <h4 class="h6 facet-title hidden-sm-down"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['facet']->value['label'], ENT_QUOTES, 'UTF-8');?>
</h4>
...
" data-toggle="collapse"<?php if (!$_smarty_tpl->tpl_vars['_collapse']->value) {?> aria-expanded="true"<?php }?>>
              <h4 class="h6 facet-title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['facet']->value['label'], ENT_QUOTES, 'UTF-8');?>
</h4>
...
"></span>
                              ...
                              <?php } else { ?>
                              <span <?php if (!$_smarty_tpl->tpl_vars['js_enabled']->value) {?> class="ps-shown-by-js" <?php }?>><i class="material-icons checkbox-checked">check</i></span>
                            <?php }?>
                          </span>
                        <?php } else { ?>
                          <span class="custom-checkbox">
