...
class PsMegaMenu extends Module {
	...
	public function __construct()
	{
		...
		$this->languages();
		$this->mscript = new PhpEncryptionLegacyEngineCore(_PSMEGAMENU_MCRYPT_KEY_);
			...
			'input' => array(
				...
				array(
					...
					'options' => array('query' => array(
							...
							array('id' => 'aligned-center', 'name' => $this->l('Align Center')),
	...
	public function getWidgetMenuContent($dir, $layout)
	{
		...
		$output .= html_entity_decode(html_entity_decode($this->display(__FILE__, 'pspagebuilder.tpl', $this->getCacheId(null, null, null)), ENT_QUOTES, "UTF-8"));
	...
	public function hookActionObjectLanguageAddAfter($params)
	{
		...
		if ($widgets)
		{
			...
			{
				$param = unserialize($this->mscript->decrypt($value['params']));
				if ($param)
				{
