...
<div class="pagebuilder-editor clearfix"> 
        ...
        <div id="screenview" class="container"><div class="row">
               ...
               <div class="col-lg-2"> 
                 ...
                 {if $id_pagebuilderprofile}
                  <div class="col-lg-3"> 
                    <p><strong>{l s='Using Shortcode In Cms Page' mod='pspagebuilder'}</strong></p>
                    <code>[pagebuilder id="{$id_pagebuilderprofile|escape:'html':'UTF-8'}"]</code>
                  </div>
                  {/if}
                  <div class="col-lg-6 pull-right">
                  
                    <div class="input-group pull-left">
                      <div><strong>{l s='Profile Name:' mod='pspagebuilder'} </strong>
                         <a data-toggle="tooltip" data-placement="bottom" title="{l s='Use This As Home Page' mod='pspagebuilder'}"  title="{l s='Click This To Set Active' mod='pspagebuilder'}" class="setdefault pull-right {if $profile->isDefault()}active{/if} ptstooltip" href="{$profile_link|escape:'html':'UTF-8'}&id_pagebuilderprofile={$profile->id|escape:'html':'UTF-8'}&setdefault=1&ajax=true" data-id="{$profile->id|escape:'html':'UTF-8'}"> <span class="icon-star"></span></a>
                      </div>
               ...
               <div id="layout-builder">
                  ...
                  <ul class="suggess-add-row-tools suggess-row-container">
                      ...
                      <li data-loading-text="<div>Loadding</div>"  class="cloud-copy ptstooltip pull-right" data-toggle="tooltip" data-placement="bottom" title="{l s='Import from our live cloud' mod='pspagebuilder'}" >
                       <a class="cloud-copy-link" href="{$cloudlink|escape:'html':'UTF-8'}" >  <i class="material-icons">cloud_download</i> </a>
                      </li>
                  </ul> 
                </div>
          </div>    
