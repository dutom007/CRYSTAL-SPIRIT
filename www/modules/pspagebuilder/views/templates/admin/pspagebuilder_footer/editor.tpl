...
<div class="pagebuilder-editor"> 
        ...
        <div id="helpPanel" style="display:none" class="container">
          <div class="panel panel-default">
            <div class="panel-heading">{l s='How to hook PS Footer Builder to your footer' mod='pspagebuilder'}</div>
            <div class="panel-body">
                <div class="alert alert-info">
                  {l s='Please following exactly these steps:' mod='pspagebuilder'}
                  <ol>
                    <li>{l s='Set the profile you want to show to default' mod='pspagebuilder'}</li>
                    <li>{l s='Copy this short-code: ' mod='pspagebuilder'}<code>{l s='{widget name="pspagebuilder"}' mod='pspagebuilder'}</code></li>
                    <li>{l s='Open your footer template file' mod='pspagebuilder'}</li>
                    <li>{l s='Paste the short-code below to the area you want to show' mod='pspagebuilder'}</li>
                  </ol>
                </div>
            </div>
          </div>
                    ...
                    <div class="pull-right">
                      ...
                      <div class="pull-right">
                        <div> <button onclick="$('#helpPanel').toggle();" type="button" id="othertool" class="btn btn-default">
                          <i class="icon-question-sign"></i> {l s='Tools' mod='Help'}</button>
                        </div>
                      </div>
