...
<div class="widget block widget-video {if isset($stylecls)&&$stylecls}block-{$stylecls|escape:'html':'UTF-8'}{/if}">
 ...
 <div class="widget-inner block_content">
 	<div class="embed-responsive">
  		<iframe class="embed-responsive-item" src="{$video_link|escape:'html':'UTF-8'}" style="width:{$width|escape:'html':'UTF-8'};height:{$height|escape:'html':'UTF-8'};" allowfullscreen="true"></iframe>
  	</div>
  {if $subinfo}
