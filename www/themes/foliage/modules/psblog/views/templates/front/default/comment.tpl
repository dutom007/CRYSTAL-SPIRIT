...
<div id="blog-localengine">
		<form class="form-horizontal" method="post" id="comment-form" action="{$blog_link|escape:'html':'UTF-8'}" onsubmit="return false;">
			...
			<div class="form-group">
				...
				<div class="col-lg-9">
					<input type="text" name="fullname" placeholder="{l s='Enter your full name' d='Shop.Theme'}" id="inputFullName" class="form-control">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-9">
					<input type="text" name="email" placeholder="{l s='Enter your email' d='Shop.Theme'}" id="inputEmail" class="form-control">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-9">
					<textarea type="text" name="comment" rows="6" placeholder="{l s='Enter your comment' d='Shop.Theme'}" id="inputComment" class="form-control"></textarea>
				</div>
			</div>
			 <div class="form-group">
			...
			<div class="form-group">
					<div class="col-lg-9 col-lg-offset-3"><button class="btn btn-default" name="submitcomment" type="submit">{l s='Submit' d='Shop.Theme'}</button></div>
			</div>
		</form>
</div>