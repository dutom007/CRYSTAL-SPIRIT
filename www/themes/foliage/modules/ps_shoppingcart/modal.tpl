  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title h6 text-xs-center" id="myModalLabel"><i class="material-icons">done</i>{l s='Product successfully added to your shopping cart' d='Shop.Theme.Checkout'}</h4>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="cart-content">
              ...
              <a href="{$cart_url}" class="btn btn-primary"><i class="material-icons">done</i>{l s='proceed to checkout' d='Shop.Theme.Actions'}</a>
            </div>
          </div>
        </div>
      </div>
