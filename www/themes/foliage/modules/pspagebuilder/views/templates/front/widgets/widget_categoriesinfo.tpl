								...
								<div class="categories-info">
									...
									<div class="categories-info-img">
										...
										<div class="categories-info-content">
											...
											{/if}
											{if $show_nb_product}
													<span class="product-number">{$cat.nb_products|escape:'htmlall':'UTF-8'} {l s='items' d='Shop.Theme'}</span>
											{/if}
										...
										{if $show_shopnow}
	                                    	<div class="btn btn-shopnow"><a href="{$link->getCategoryLink({$cat.id_category|escape:'htmlall':'UTF-8'})|escape:'htmlall':'UTF-8'}" title="{l s='Shop Now!' d='Shop.Theme'}"> <i class="fa fa-long-arrow-right"></i></a></div>
	                                    {/if} 
									</div>
