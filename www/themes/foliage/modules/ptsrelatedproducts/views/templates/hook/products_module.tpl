...
<div class="{if isset($carousel_style) && $carousel_style} {$carousel_style}{/if} widget-content owl-carousel-play" data-ride="owlcarousel">
 	{if count($items) > $carousel_item}
	 	<div class="carousel-controls">
		 	<a class="left carousel-control left_carousel" href="#"><span class="fa fa-caret-left"></span></a>
			<a class="right carousel-control right_carousel" href="#"><span class="fa fa-caret-right"></span></a>
		</div>
	{/if}
