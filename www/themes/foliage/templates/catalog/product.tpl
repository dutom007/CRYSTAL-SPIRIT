        ...
        <div class="col-md-6">
          ...
          {block name='page_header_container'}
            {block name='page_header'}
              <h2  >{block name='page_title'}{$product.name}{/block}</h2>
            {/block}
          {/block}
          <br>

        <!-- On enlève les infos ( date de dispo et ref )
            ...
            {block name='product_description_short'}
              ...
              <div id="product-description-short-{$product.id}" itemprop="description">
				...
				<!-- Si résumé -->
                  ...
                  <span class="label" style="text-decoration:underline">{l s='Information:' d='Shop.Theme.Catalog'}</span>
    ...
    {block name='product_accessories'}
        {if $accessories}
            <div class="product-accessories clearfix block">
              <h4 class="title_block">{l s='Related Products..' d='Shop.Theme.Catalog'}</h4>
              <div class="products">
