            ...
            <div class="item">
                <div class="product-block clearfix" itemscope itemtype="https://schema.org/Product">
                    <div class="product-container media">
                        <a class="float-xs-left products-block-image img" href="{$product->product_link|escape:'html'}" title="{$product->legend|escape:html:'UTF-8'}">   <img class="replace-2x img-responsive" src="{$link->getImageLink($product->link_rewrite, $product->id_image, 'small_default')|escape:'html'}" alt="{$product->name|escape:html:'UTF-8'}" />
                        </a>
                        <div class="media-body">
                            <div class="product-content">
                                ...
                                {hook h='displayProductListReviews' product=$product->id_image}
