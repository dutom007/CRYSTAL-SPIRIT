  ...
  <div class="thumbnail-container">
    <div class="left-block">
      ...
      <div class="product-list-actions">
        ...
        {/block}
        <a href="#" class="quick-view hidden-sm-down" data-link-action="quickview" title="{l s='Quick view' d='Shop.Theme.Actions'}">
          <i class="material-icons">zoom_in</i> <!-- {l s='Quick view' d='Shop.Theme.Actions'} -->
        </a>
      </div>
